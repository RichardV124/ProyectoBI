...
import entidades.AuditoriaLogin;
import excepciones.ExcepcionNegocio;
import persistencia.Persistencia;

@LocalBean
@Stateless
public class AuditoriaLoginEJB {
	 ...
	 */
	public void crear(AuditoriaLogin auditoria, int bd, boolean ingreso, String browserDeta) {
	 ...
	 */
	public List<AuditoriaLogin> listar(int bd){
		em.setBd(bd);	
		List<AuditoriaLogin> auditorias= (List<AuditoriaLogin>)(Object)em.listar(AuditoriaLogin.CONSULTA_LISTAR_AUDITORIAS);
