...
import entidades.AuditoriaProducto;
...
public class AuditoriaProductoEJB {
	 ...
	 */
	public void crear(AuditoriaProducto auditoria, int bd, String accion, String browserDeta) {
	 ...
	 */
	public List<AuditoriaProducto> listar(int bd){
		em.setBd(bd);	
		List<AuditoriaProducto> auditorias= (List<AuditoriaProducto>)(Object)em.listar(AuditoriaProducto.CONSULTA_LISTAR_AUDITORIAS);
