...
@LocalBean
@Stateless
public class AuditoriaAccesoEJB {
	 ...
	 */
	public void crear(AuditoriaAcceso auditoria, int bd, String accion, String browserDeta) {
	 ...
	 */
	public List<AuditoriaAcceso> listar(int bd){
		em.setBd(bd);	
		List<AuditoriaAcceso> auditorias= (List<AuditoriaAcceso>)(Object)em.listar(AuditoriaAcceso.CONSULTA_LISTAR_AUDITORIAS);
