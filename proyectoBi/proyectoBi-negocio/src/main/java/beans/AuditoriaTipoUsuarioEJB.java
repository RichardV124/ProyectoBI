...
import entidades.AuditoriaTipoUsuario;
...
public class AuditoriaTipoUsuarioEJB {
	 ...
	 */
	public void crear(AuditoriaTipoUsuario auditoria, int bd, String accion, String browserDeta) {
	 ...
	 */
	public List<AuditoriaTipoUsuario> listar(int bd){
		em.setBd(bd);	
		List<AuditoriaTipoUsuario> auditorias= (List<AuditoriaTipoUsuario>)(Object)em.listar(AuditoriaTipoUsuario.CONSULTA_LISTAR_AUDITORIAS);
