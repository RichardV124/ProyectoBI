...
import entidades.AuditoriaVenta;
import excepciones.ExcepcionNegocio;
import persistencia.Persistencia;

@LocalBean
@Stateless
public class AuditoriaVentaEJB {
	 ...
	 */
	public void crear(AuditoriaVenta auditoria, int bd, String accion, String browserDeta) {
	 ...
	 */
	public List<AuditoriaVenta> listar(int bd){
		em.setBd(bd);	
		List<AuditoriaVenta> auditorias= (List<AuditoriaVenta>)(Object)em.listar(AuditoriaVenta.CONSULTA_LISTAR_AUDITORIAS);
