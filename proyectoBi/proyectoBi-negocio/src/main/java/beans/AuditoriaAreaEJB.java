...
import entidades.AuditoriaArea;
...
public class AuditoriaAreaEJB {
		 ...
		 */
		public void crear(AuditoriaArea auditoria, int bd, String accion, String browserDeta) {
		 ...
		 */
		public List<AuditoriaArea> listar(int bd){
			em.setBd(bd);	
			List<AuditoriaArea> auditorias= (List<AuditoriaArea>)(Object)em.listar(AuditoriaArea.CONSULTA_LISTAR_AUDITORIAS);
